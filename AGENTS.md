...
- `design_guidelines.md/` — explain what lives here and when agents should edit it.
- `drizzle.config.ts/` — explain what lives here and when agents should edit it.
- `ecosystem.config.cjs/` — explain what lives here and when agents should edit it.
